...
split_variables.c main.c checkers.c exit.c heredoc.c is_helper.c confirm_syntax.c \
parser_node_creation.c expander_handlers.c delete_empty_tokens.c heredoc_read_loop.c heredoc_expander.c \
heredoc_save_file.c free.c free_structs.c 
